...
| [architecture/decisions/index.md](architecture/decisions/index.md) | Architecture Decision Records (ADR-001…); latest: [ADR-053](architecture/decisions/ADR-053.md) in-app build-status / `alwaysVisible` nav |
